<%@ Page Title="" Language="C#" MasterPageFile="~/Master.Master" AutoEventWireup="true" CodeBehind="buscadorUsuarios.aspx.cs" Inherits="Hyper2.buscadorUsuarios" %>
                          ...
                          <ItemTemplate>
                            <tr runat="server">
                                ...
                                <td runat="server" style="text-align:center;">
                                    ...
                                    <asp:LinkButton ID="ButtonMore" runat="server" CssClass='<%#Eval("Name") %>' OnClick="iniciarChat">
