    ...
    <div class="col_group">
        <div>
            ...
            <ul class="input-group" style="list-style-type:none; width:25em;">
                ...
                <li><asp:TextBox ID="textBox_username" runat="server" style="border-radius:4px;" type="text" class="form-control" placeholder="Nombre de usuario" aria-describedby="basic-addon1" /></li>
                <li style="margin-bottom:1em;"><asp:Label ID="label_username" CssClass="label_error" runat="server"></asp:Label></li>
                <li><asp:TextBox ID="textBox_email" runat="server" style="border-radius:4px;" type="text" class="form-control" placeholder="Email" aria-describedby="basic-addon1" /></li>
