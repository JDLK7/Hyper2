...
namespace Hyper2
{
    public partial class buscador : System.Web.UI.Page
    {
        ...
        protected void descargarArchivo(object sender, EventArgs e)
        {
            ...
            string ubicacion = boton.CssClass;
            /*
            int aux = ubicacion.LastIndexOf(' ');
            ubicacion = ubicacion.Substring(0, aux);
            aux = ubicacion.LastIndexOf(' ');
            ubicacion = ubicacion.Substring(0, aux);
            */
            int index = ubicacion.LastIndexOf(".");

            if(index > 0) //archivo
            {

                FileInfo fileInfo = new FileInfo(ubicacion);
            ...
            {
                ubicacion = compressedPath + CompressFolder(ubicacion);
        ...
        public string CompressFolder(string path)
        {
            ...
            ZipFile.CreateFromDirectory(path, compressedPath + name);
